...
<main>
    <section class="py-5 container">
        ...
        <div class="row py-lg-5">
            ...
            <h1 class="border-bottom text-center pb-3 mb-5">ADD CATEGORY</h1>

            <div class="col-lg-6 col-md-8 mx-auto card p-5">
            <form action="/dashboard/categories/create" method="POST" class="justify-content-md-end">
                @csrf
...
$('#name').change(function(e) {
    $.get('{{ route('dashboard.categories.check_slug') }}',
        { 'name': $(this).val() },
        function( data ) {
            $('#slug').val(data.slug);
        }
